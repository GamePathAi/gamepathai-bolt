/*
  ...
  1. Changes
    - Correct policy syntax for INSERT operations by removing USING clause
    - Keep only WITH CHECK expressions for INSERT policies
    - Maintain all other policies and functions unchanged
  
  2. Security
    - Maintain all security policies with proper syntax
    - Keep all functions for security audit logging and trial management
*/
...
-- For INSERT policies, remove USING clause and keep only WITH CHECK
