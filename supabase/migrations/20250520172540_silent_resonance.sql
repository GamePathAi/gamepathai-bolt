/*
  # Security Events and Activity Logging System
  ...
  2. Functions
    - `log_security_event` - Records security events with contextual information
    - `log_user_activity` - Logs user activities with resource information
