/*
  ...
  1. New Tables
    - `security_logs` - Logs authentication events and security-related activities
  ...
  3. Authentication
    ...
    - Add support for account locking after failed attempts
*/
...
CREATE POLICY "Allow authenticated insert access to security_logs" 
  ON security_logs FOR INSERT TO authenticated USING (true);
