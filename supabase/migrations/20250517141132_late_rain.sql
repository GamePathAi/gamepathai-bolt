/*
  # Fix RLS policies and add trial management functions

  1. Security
    - Update RLS policies to use auth.uid() consistently
    - Fix INSERT policies by removing USING clause (keeping only WITH CHECK)
    - Update security audit logging function
  
  2. New Functions
    - Add trial status checking function
