/*
  ...
  1. Changes
     - Corrected INSERT policies to only use WITH CHECK expressions (not USING)
     - Maintained all other policy expressions
     - Kept all security functions intact
  
  2. Security
     - Maintained all security checks using auth.uid()
     - Preserved all access control mechanisms
*/
