        ...
        <div className="bg-gray-800/60 backdrop-blur-sm border border-purple-500/20 rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="bg-gray-900/50 rounded-lg p-3">
              ...
              <div className="text-lg font-medium text-white">{metrics.cpu.usage}%</div>
            </div>
            <div className="bg-gray-900/50 rounded-lg p-3">
              <div className="text-xs text-gray-400">Memory Used</div>
              <div className="text-lg font-medium text-white">{metrics.memory.used}/{metrics.memory.total} GB</div>
            </div>
            <div className="bg-gray-900/50 rounded-lg p-3">
              <div className="text-xs text-gray-400">CPU Cores</div>
              <div className="text-lg font-medium text-white">{metrics.cpu.cores}</div>
            </div>
            <div className="bg-gray-900/50 rounded-lg p-3">
              <div className="text-xs text-gray-400">Free Memory</div>
              <div className="text-lg font-medium text-white">{metrics.memory.free} GB</div>
            </div>
            <div className="bg-gray-900/50 rounded-lg p-3 border border-purple-500/30">
              ...
              <div className="text-lg font-medium text-purple-400">{metrics.gpu?.usage || 0}%</div>
            </div>
            <div className="bg-gray-900/50 rounded-lg p-3 border border-orange-500/30">
              ...
              <div className="text-lg font-medium text-orange-400">{metrics.gpu?.temperature || 0}°C</div>
            </div>
          </div>
        </div>
      )}
