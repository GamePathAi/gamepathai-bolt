/*
  # Fix policy syntax for auth.uid() usage

  1. Changes
    - Fix syntax errors in policy statements
    - Properly format all policy alterations
    - Maintain all security functions
  
  2. Security
    - Update policies to use auth.uid() correctly
    - Maintain security audit logging functionality
    - Preserve trial management functions
*/
