 ...
 */
function (games: GameInfo[]): GameInfo[] {
 ...
 */
function (games: GameInfo[],  = MAX_GAMES_PER_PLATFORM): GameInfo[] {
...
module.exports = { to, normalizedPath, normalizedDir, normalizedPath, systemDirs, fileName, dirPath, normalizedPath, filteredGames, uniqueGames, key, existing, steamAppIdMatch, aPriority, bPriority, platform, platformGames };