...
export class GameManager {
  ...
  private async scanAndUpdateGames() {
    try {
  ...
  private async updateGameInDatabase(gameInfo: GameInfo) {
    try {
...
const  = GameManager.getInstance();

module.exports = { gameProcesses, gameDetails, path };